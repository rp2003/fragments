...
//       // Perform the PUT request (updated to no extension in the URL)
//       const response = await request(app)
//         .put('/v1/fragment/06dbf21a-52c0-4d03-87a9-8d567bd8673e')
//         .send({ newType: 'newType' });  // Assuming you might send type or other data

//       // Verify the response status
//       expect(response.status).toBe(200);

//       // Create a new expected fragment object
...
//         updated: '2024-10-05T20:44:37.548Z',
//         size: 14,
//         type: 'newType',  // Assuming you convert to this type
//       };
...
//     });
    ...
    test('should return 404 if fragment not found', async () => {
      ...
      const response = await request(app)
        .put('/v1/fragment/invalid-id')
        .send({ newType: 'newType' });
...
//       const response = await request(app)
//         .put('/v1/fragment/06dbf21a-52c0-4d03-87a9-8d567bd8673e')
//         .send({ newType: 'invalidType' });  // Send invalid type or extension
